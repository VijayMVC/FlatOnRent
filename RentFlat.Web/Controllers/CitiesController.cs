...
namespace RentFlat.Web.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,CityName,CountryId")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,CityName,CountryId")] City city)
        {
            if (ModelState.IsValid)
            {
